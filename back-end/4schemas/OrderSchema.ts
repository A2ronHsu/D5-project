...
export const OrderJsonValidation  = (input: OrderJson[]) : OrderJson[] => {
   input.forEach(order => {
      ...
      const notNullandTypeCheck : boolean = !!nota && typeof (nota) == 'string' && !!comentario && typeof (comentario) == 'string'&& !!codigoCliente && typeof (codigoCliente) == 'string'&& !!nombreCliente && typeof (nombreCliente) == 'string'&& !!fecha && typeof (fecha) == 'string'&& !!hora && typeof (hora) == 'string'&& !!printStatus && typeof (printStatus) == 'string'&& !!deposito && typeof (deposito) == 'string'&& !!codigoVendedor && typeof (codigoVendedor) == 'string'&& !!nombreVendedor && typeof (nombreVendedor) == 'string'
